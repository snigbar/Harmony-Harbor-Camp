...
const InstructorClasses = () => {
    ...
    const classesByInstructor = classes.filter((classItem) => classItem.instructorName === instructor.name);
  ...
  return (
    ...
    <h1 className='text-3xl text-indigo-950 font-semibold uppercase'>{instructors.name}</h1>
