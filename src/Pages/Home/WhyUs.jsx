...
const WhyUs = () => {
  ...
  return (
    ...
    <h1 className='text-3xl text-indigo-950 font-semibold uppercase'>Your Gateway to Unforgettable Summers</h1>
    <p className="text-center text-sm md:text-lg text-indigo-950 mt-6 w-full md:w-4/5 mx-auto">Choose Harmony Harbor for your summer instrument learning experience and harmonize your passion for music with the joys of summer, surrounded by expert instructors and a supportive community of fellow music enthusiasts</p>
    </div>
    </div>

<div className="w-full py-6 gap-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-items-center">

 { whyUs.map((element) =>  <div className="w-4/5 h-96 md:w-72 text-center px-2 py-3 bg-white rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl">
    ...
    <p className="text-sm text-gray-600 pb-2">{element.description}</p>
    </div>
  </div>)}
