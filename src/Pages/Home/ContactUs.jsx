...
const ContactUs = () => {
  return (
    ...
    <h1 className='text-3xl text-indigo-950 font-semibold uppercase'>Contact Us</h1>
    </div>
    </div>

        <div className="relative flex items-top justify-center min-h-[60vh] py-8 bg-white dark:bg-gray-900 sm:items-center sm:pt-0">
